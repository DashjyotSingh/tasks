    ...
    <>
      ...
      <div className='container mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh]'>
        <div className="addTodo my-5">
          ...
          <button onClick={handleAdd} className='bg-violet-800 hover:bg-violet-950 p-2 py-1 font-bold text-white rounded-md mx-6'>Add</button>
        </div>
        ...
        return <div key={item.id} className="todo flex w-1/4 my-3 justify-between">
          ...
          <div className="buttons">
            <button onClick={handleEdit} className='bg-violet-800 hover:bg-violet-950 p-2 py-1 font-bold text-white rounded-md mx-1'>Edit</button>
